...
[NOTICE](NOTICE) records the attribution and the statement of changes that
Apache 2.0 section 4(b) asks a modified work to carry: which upstream commit
this forked from, which areas were changed, and what each licence file in the
tree actually governs. Ship it with any redistribution.
...
This fork is at [albanread/MojoRISCOS](https://github.com/albanread/MojoRISCOS).
Upstream is [modular/modular](https://github.com/modular/modular). All original
design credit belongs to Modular.
